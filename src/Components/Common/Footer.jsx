        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          ...
          <div className="mt-12 pt-8 border-t border-white/20">
            ...
            <div className="grid grid-cols-3 gap-4 mb-8">
              {[
                { icon: Users, number: "90+", label: "Participants" },
                { icon: Calendar, number: "130", label: "Events" },
                { icon: Trophy, number: "10+", label: "Winners" },
              ].map((stat, index) => {
...
//   return (
//     <footer className="bg-bg-[oklch(43.7%_0.078_188.216)] text-background relative overflow-hidden">
//       <div className="absolute inset-0 festival-gradient opacity-10 animate-gradient-shift"></div>

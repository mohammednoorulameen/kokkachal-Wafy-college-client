...
//         const data = res.data
//         if (data.success) {
//           // Transform backend response (grouped by category)
//           const formatted = Object.keys(data.data).map((cat) => ({
//             category: cat,
//             programs: data.data[cat].map((p) => ({
//               programId: p.programId,
...
//       <section className="bg-white text-black min-h-screen py-20">
//         <div className="max-w-6xl mx-auto px-4">
//           <h2 className="text-2xl md:text-3xl text-red-600 font-bold mb-6 text-center">
//             (Working Progress not completed please wait)
//           </h2>
//           <h2 className="text-2xl md:text-3xl font-bold mb-6 text-center">
//             All Results of Program
//           </h2>

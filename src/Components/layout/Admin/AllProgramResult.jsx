    ...
    setSelectedStudents((prev) => ({
      ...
      [programId]: {
        ...
        [studentId]: {
          ...
          points: prev[programId]?.[studentId]?.points || 0,
        },
      },
    }))
  }

  // Submit selected students and toggle isActive + grade + points
      ...
      const promises = checkedStudents.map((student) =>
        adminInstance.put(
          `/adminchange-user-status/${student._id}/${program.programId}`,
          {
            ...
            points: selectedStudents[program.programId][student._id]?.points || 0,
          },
          { headers: { Authorization: `Bearer ${token}` } }
        )
      )
                  ...
                  if (cs) {
                    return {
                      ...
                      program: {
                        ...
                        points: selectedStudents[program.programId][s._id]?.points || 0,
                      },
                    }
                  }
                  return s
                          ...
                          <div className="text-sm text-black/70 space-y-1">
                            ...
                            <div className="mt-1 flex items-center gap-1">
                              ...
                              <input
                                type="number"
                                value={
                                  selectedStudents[program.programId]?.[student._id]?.points ??
                                  student.program.points ??
                                  0
                                }
                                onChange={(e) => {
                                  ...
                                  setSelectedStudents((prev) => ({
                                    ...
                                    [program.programId]: {
                                      ...
                                      [student._id]: {
                                        ...
                                        points,
                                        selected:
                                          prev[program.programId]?.[student._id]?.selected || false,
                                        grade:
                                          prev[program.programId]?.[student._id]?.grade ||
                            ...
                            <div className="mt-1 flex items-center gap-1">
                              ...
                              <input
                                type="text"
                                value={
                                  selectedStudents[program.programId]?.[student._id]?.grade ||
                                  student.program.grade ||
                                  ""
                                }
                                onChange={(e) => {
                                    ...
                                    [program.programId]: {
                                      ...
                                      [student._id]: {
                                        ...
                                        selected:
                                          prev[program.programId]?.[student._id]?.selected || false,
                                        points:
                                          prev[program.programId]?.[student._id]?.points ||
                                          student.program.points ||
                                          0,
                                      },
                                    },
                            ...
                            <p
                              className={`font-bold ${
                                student.program.isActive ? "text-green-600" : "text-red-600"
                              }`}
                            >
